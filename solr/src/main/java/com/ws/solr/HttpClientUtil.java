...
public class HttpClientUtil {
    ...
    /**
     * 发送 http put 请求，支持文件上传
     */
    public static HttpResponse httpPutFormMultipart(String url, List<File> files, Map<String, String> headers, String encode) {
        HttpResponse response = new HttpResponse();
        if (encode == null) {
            encode = "utf-8";
        }
